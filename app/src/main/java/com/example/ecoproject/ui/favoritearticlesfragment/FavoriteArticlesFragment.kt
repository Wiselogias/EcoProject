...
class FavoriteArticlesFragment : BaseFragment<MainActivity>() {
    @Inject
    lateinit var viewModel: FavoriteArticlesViewModel
    ...
    override fun onAttach(context: Context) {
        ...
        baseActivity.activityComponent.favoriteArticlesSubcomponent.inject(this)
    }
    ...
    override fun onCreateView(
        ...
        binding.toolBar.title = getString(R.string.favorite_articles)
